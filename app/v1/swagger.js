...
const options = {
  ...
  apis: [
    ...
    './app/routes/api/sport.router.js',
    './app/routes/api/sports_team.routes.js',
    './app/routes/api/team.router.js',
    './app/routes/api/tournament.router.js',
    './app/routes/api/create_game.router.js',
    './app/routes/api/game_score.router.js',
    './app/routes/api/subscription.router.js',
    './app/routes/api/help_and_support.router.js',
    './app/routes/api/notifications.router.js',
    './app/routes/api/meta_data.router.js',
    './app/routes/api/subscription_plan.router.js',
